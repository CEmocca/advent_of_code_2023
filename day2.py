...
class Day2:
    ...
    def determine_cube(self, input: str):
...
input_day2 = '''Game 1: 4 blue, 16 green, 2 red; 5 red, 11 blue, 16 green; 9 green, 11 blue; 10 blue, 6 green, 4 red
...
print(day2.determine_cube(input_day2))
